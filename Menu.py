# -*- coding: utf-8 -*-
"""
Created on Tue Jul  2 09:48:40 2024
...
def open_pygame(button_label):
    ...
    # Pass the button label as an argument to the Pygame script
...
# Title 
title_label = tk.Label(root, text="BattleShip", font=font_title, bg=DARK_GRAY, fg=WHITE)
